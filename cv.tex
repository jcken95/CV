...
{\begin{itemize}
  ...
  \item {Applied machine learning/data visualisation methods for error detection in complex databases. \vspace{0.1cm}}
  \item {Final result included a predictive model to cost vehicles, saving hundreds of hours per year and allowing product costing data to be updated monthly rather than annually. \vspace{0.1cm}}
\end{itemize}
}
