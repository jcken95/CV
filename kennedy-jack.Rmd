...
ukhsa_experience <- c(
  ...
  "Developing a culture of writing clean, maintainable code & modelling pipelines"
)
...
skills <- tibble::tribble(
  ...
  "Statistics & Machine Learning", "Bayesian methods, linear andflexible regression, Bayesian optimisation, clustering, classification, inference, prediction", # nolint: line length linter
