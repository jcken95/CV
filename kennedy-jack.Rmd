...
undergrad_notes <- c(
  ...
  "Provided Nissan's finance team with a statistical and ML toolbox to help them understand their data; regression for fast product costing; dimension reduction and clustering for outlier detection",
  "Studied a range of mathematical and statistical topics: regression & statistical modelling; Markov models; time series; queuing theory; extreme value theory; flexible regression; multivariate methods"
)
...
rss_notes <- c(
  "Active member of the Royal statistical society; organised a variety of in-person and online events; collaborating with Head of Conferences and Events to organise conference sessions",
  "Member & Chair of the Young Statisticians Section; supporting early-career statisticians and data scientists",
  "Overseeing a team of 12 volunteers as chair of the YSS",
...
misc_notes <- c(
  "Participate in #TidyTuesday data visualisation challenge to practise visualisation and learn new-to-me R packages; see github profile for portfolio",
  glue::glue("Top 5% overall contributor on Crossvalidated. As of {todays_date_friendly} gained {cv_stats$reputation} reputation and {cv_badges} badges")
)
...
professional_interests = c(
  "Technical: Bayesian methods; data visualisation; modelling; reproducibility",
