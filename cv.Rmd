...
I enjoy telling stories with data, working with technology, and finding data-driven solutions to challenging problems.
...
service <- tibble::tribble(
  ...
  "", "", "", "Projects & Online Activity", misc_notes,
)
service %>%
  detailed_entries(
    what = job,
